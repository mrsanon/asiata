...
var OWNER = { number: '94766816809,94766816809' }
const OWNER2 = '94766816809,0'
...
async function Asiatabot () {
    ...
    cobrabotconn.on('connecting', async () => {
        console.log(`${chalk.green.bold('Asiata')}${chalk.blue.bold('Bot')}
        ...
        events.commands.map(
            async (command) =>  {
                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if ((OWNER.number == "94766816809,94766816809" && msg.key.fromMe === false && command.fromMe === true &&
                    ...
                    if ((OWNER2 == '94766816809,0' && msg.key.fromMe === false && command.fromMe === true &&
                    ...
                    if (sendMsg) {
                        ...
                        try {
                            ...
                            if (config.LANG == 'SI') {
                                await cobrabotconn.sendMessage(cobrabotconn.user.jid, '*♦︎✧දෝෂ වාර්තාව (🐋ASIATABOT 🐋)✧♦︎*' + 
                                    '\n*ASIATABOT දෝෂයක් සිදු වී ඇත!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await cobrabotconn.sendMessage(cobrabotconn.user.jid, '*♦︎✧දෝෂ විසඳුම (🐋ASIATABOT 🐋)✧♦︎*' + 
                                        '\n========== ```දෝෂය කියවන්න!``` ==========' +
                                ...
                                await cobrabotconn.sendMessage(cobrabotconn.user.jid, '*-- ERROR REPORT [🐋ASIATABOT 🐋] --*' + 
                                ...
                                if (error.message.includes('URL')) {
                                    return await cobrabotconn.sendMessage(cobrabotconn.user.jid, '*⚕️ ERROR ANALYSIS [🐋ASIATABOT 🐋] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
