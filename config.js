...
module.exports = {
    ...
    CAP_BIO: process.env.CAP_BIO === undefined ? '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 ASIATA ²⁰²²' : process.env.CAP_BIO,
    CAPTION: process.env.CAPTION === undefined ? '© 𝙶𝙴𝙽𝙴𝚁𝙰𝚃𝙴𝙳 𝙱𝚈 ASIATA ²⁰²²' : process.env.CAPTION,
    ...
    DEPLOYER: process.env.DEPLOYER === undefined ? 'ASIATA USER' : process.env.DEPLOYER,
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? 'AsiataBOt' : process.env.BOT_NAME,
