...
Asiata.addCommand({pattern: 'install ?(.*)', fromMe: true, desc: Lang.INSTALL_DESC, warn: Lang.WARN, deleteCommand: false}, (async (message, match) => {

    if (match[1] == '') return await message.client.sendMessage(message.jid, Lang.NEED_URL + '.install https://gist.github.com/thisano4/94eab9bab000ba322436bc7f9dad80dd', MessageType.text)
    try {
...
Asiata.addCommand({pattern: 'plugin$', fromMe: true, desc: Lang.PLUGIN_DESC , deleteCommand: false}, (async (message, match) => {
...
Asiata.addCommand({pattern: 'remove(?: |$)(.*)', fromMe: true, desc: Lang.REMOVE_DESC, deleteCommand: false }, (async (message, match) => {
