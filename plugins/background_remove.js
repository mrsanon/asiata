...
if (Config.WORKTYPE == 'private') {
    ...
    Asiata.addCommand({pattern: 'removebg ?(.*)', fromMe: true, desc: Lang.REMOVEBG_DESC,  deleteCommand: false }, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid,fs.readFileSync('rbg.png'), MessageType.document, {filename: '🐋AsiataBot 🐋.png', mimetype: Mimetype.png, quoted: message.data});
        await load.delete();
    }));
}
else if (Config.WORKTYPE == 'public') {

    Asiata.addCommand({pattern: 'removebg ?(.*)', fromMe: false, desc: Lang.REMOVEBG_DESC,  deleteCommand: false}, (async (message, match) => {
