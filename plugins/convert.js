...
if (Config.WORKTYPE == 'private') {
    ...
    Asiata.addCommand({pattern: 'mp4audio$', fromMe: true, desc: Lang.MP4TOAUDİO_DESC, deleteCommand: false}, (async (message, match) => {
    ...
    Asiata.addCommand({pattern: 'imagesticker$', fromMe: true, desc: Lang.STİCKER_DESC, deleteCommand: false}, (async (message, match) => {
        const mid = message.jid
    ...
    Asiata.addCommand({pattern: 'vsticker$', desc: Lang.ANİM_STİCK, fromMe: true, deleteCommand: false}, (async (message, match) => {
       const mid = message.jid
    ...
    Asiata.addCommand({pattern: 'mp4audio$', fromMe: false, desc: Lang.MP4TOAUDİO_DESC, deleteCommand: false}, (async (message, match) => {
        const mid = message.jid
        if (message.reply_message === false) return await message.client.sendMessage(mid, Lang.MP4TOAUDİO_NEEDREPLY, MessageType.text);
        var downloading = await message.client.sendMessage(mid,Lang.MP4TOAUDİO,MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
    ...
    Asiata.addCommand({pattern: 'imagesticker$', fromMe: false, desc: Lang.STİCKER_DESC, deleteCommand: false}, (async (message, match) => {
        const mid = message.jid
        if (message.reply_message === false) return await message.client.sendMessage(mid, Lang.STİCKER_NEEDREPLY, MessageType.text);
        var downloading = await message.client.sendMessage(mid,Lang.STİCKER,MessageType.text);
        var location = await message.client.downloadAndSaveMediaMessage({
    ...
    Asiata.addCommand({pattern: 'vsticker$', desc: Lang.ANİM_STİCK, fromMe: false, deleteCommand: false}, (async (message, match) => {
        const mid = message.jid
        if (message.reply_message === false) return await message.sendMessage(Lang.STİCKER_NEEDREPLY);
      var up =  await message.client.sendMessage(mid, Lang.ANİMATE, MessageType.text)
        const savedFilename = await message.client.downloadAndSaveMediaMessage({
