...
if (Config.WORKTYPE == 'private') {
    ...
    Asiata.addCommand({pattern: Config.CUS_PANEL + '?(.*)', fromMe: true, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({pattern: Config.CUS_PANEL + '?(.*)', fromMe: false, dontAddCommandList: true, deleteCommand: false}, (async (message, match) => {
