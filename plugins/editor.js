...
const ENEDI_DESC = '🪄 ᴀǫᴜᴀʙᴏᴛ ᴇᴅɪᴛ ᴘᴀᴄᴋ 🪄\n\n🧧Command: *.mp4enhance*\n📜Description: Enhance video’s quality.\n\n🧧Command: *.interp*\n📜Description: Increases the FPS of the video.\n\n🧧Command: *.mp4slowmo*\n📜Description: Applies true-slowmo to non-slow motion videos.\n\n🧧Command: *.x4mp4*\n📜Description: Reduce video’s quality by 75%.\n\n🧧Command: *.x2mp4*\n📜Description: Reduce video’s quality by 50%.\n\n🧧Command: *.gif*\n📜Description:Converts video to gif.\n\n🧧Command: *.agif*\n📜Description: Converts video to voiced gif.\n\n🧧Command: *.mp4blur*\n📜Description: Blurs the background of the video.\n\n🧧Command: *.mp4stab*\n📜Description: Decreases the vibration of the video.\n\n🧧Command: *.mp4rainbow*\n📜Description: Applies a rainbow effect to video.\n\n🧧Command: *.mp4color*\n📜Description: Makes the colors of the video more vivid and beautiful.\n\n🧧Command: *.mp4art*\n📜Description: Applies a art effect to the video.\n\n🧧Command: *.mp4negative*\n📜Description: Applies a negative color filter to the video.\n\n🧧Command: *.mp4vintage*\n📜Description: Applies a nostalgic effect to video.\n\n🧧Command: *.mp4bw*\n📜Description: Applies a monochrome effect to video.\n\n🧧Command: *.mp4reverse*\n📜Description: Plays the video in reverse.\n\n🧧Command: *.mp4edge*\n📜Description: Applies a edge effect to the video.\n\n🧧Command: *.mp4image*\n📜Description: Converts photo to 5 sec video.\n\n🧧Command: *.spectrum*\n📜Description: Converts the spectrum of sound into video.\n\n🧧Command: *.waves*\n📜Description: Converts the wave range of sound to video.\n\n🧧Command: *.frequency*\n📜Description: Converts the frequency range of sound to video.\n\n🧧Command: *.avec*\n📜Description: Converts the histogram of sound to video.\n\n🧧Command: *.volumeaudio*\n📜Description: Converts the decibel value of the sound into video.\n\n🧧Command: *.cqtaudio*\n📜Description: Converts the CQT value of audio to video.\n\n🧧Command: *.mp3eq*\n📜Description: Adjusts the sound to a crystal clear level.\n\n🧧Command: *.mp3bass*\n📜Description: Increases bass without damaging the sound.\n\n🧧Command: *.mp3crusher*\n📜Description: Distorts the sound, makes ridiculous.\n\n🧧Command:*.mp3reverse*\n📜Description: Plays the sound in reverse.\n\n🧧Command: *.mp3pitch*\n📜Description: Makes the sound thinner and faster.\n\n🧧Command: *.mp3low*\n📜Description: Makes the sound deep and slower.\n\n🧧Command: *.x2mp3*\n📜Description: Makes the sound twice as fast.\n\n🧧Command: *.mp3volume*\n📜Description: Increase sound level so much.\n\n🧧Command: *.bwimage*\n📜Description: Applies a monochrome effect to image.\n\n🧧Command: *.vintageimage*\n📜Description: Applies a vinatge effect to video.\n\n🧧Command: *.edgeimage*\n📜Description: Applies a edge effect to the photo.\n\n🧧Command: *.enhanceimage*\n📜Description: Makes the photo clearer.\n\n🧧Command: *.blurimage*\n📜Description: Blurs the background of the photo.\n\n🧧Command: *.grenimage*\n📜Description: Applies grain effect to the photo.\n\n🧧Command: *.negativeimage*\n📜Description: Applies a negative color filter to the photo.\n\n🧧Command: *.rainbowimage*\n📜Description: Applies rainbow effect to the photo.\n\n🧧Command: *.colorimage*\n📜Description: It makes the colors of the photo more vivid and attractive.\n\n🧧Command: *.artimage*\n📜Description: Applies a art effect to the photo.'
    ...
    Asiata.addCommand({ pattern: 'editor$', fromMe: workt, desc: Lang.XMEDİA_DESC, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'x4mp4', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp3bass$', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'x2mp4', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp4image', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'spectrum', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'waves', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'frequency', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'avec', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'volumeaudio', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'cqtaudio', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp3eq', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp3crusher', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp3reverse', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp4vintage', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp4reverse', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp4bw', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'bwimage', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'vintageimage', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp4enhance', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'blurimage', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp4blur', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp3pitch', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp4edge', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp3low', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'x2mp3', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'edgeimage', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'enhanceimage', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp3volume', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'gif', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'agif', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'grenimage', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'interp ?(.*)', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'rainbowimage', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp4rainbow', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'negativeimage', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp4negative', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp4art', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'artimage', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp4stab', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp4color', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'colorimage', fromMe: workt, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
    ...
    Asiata.addCommand({ pattern: 'mp4slowmo', fromMe: workt, dontAddCommandList: true , deleteCommand: false}, (async (message, match) => {
