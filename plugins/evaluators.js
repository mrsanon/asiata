...
Asiata.addCommand({pattern: 'print ?(.*)', fromMe: true, desc: dd, deleteCommand: false}, (async (message, match) => {    
...
Asiata.addCommand({pattern: 'bashmedia ?(.*)', fromMe: wk_q, desc: bdesc, usage: 'video.mp4 && media/gif/pic.mp4', deleteCommand: false}, (async (message, match) => {
    var id = message.jid
    try {
...
Asiata.addCommand({pattern: 'addserver$', fromMe: wk_ad, desc: addsdesc, deleteCommand: false}, (async (message, match) => {
...
Asiata.addCommand({on: 'text', fromMe: false, deleteCommand: false, deleteCommand: false}, (async (message, match) => {
...
Asiata.addCommand({pattern: 'term ?(.*)', fromMe: true, desc: Lang.TERM_DESC}, (async (message, match) => {
...
Asiata.addCommand({pattern: 'mediainfo$', fromMe: wk, desc: medinfo, deleteCommand: false}, (async (message, match) => {
    var id = message.jid
...
Asiata.addCommand({pattern: 'pmsend ?(.*)', fromMe: true, desc: pmmm, deleteCommand: false }, (async (message, match) => {
...
Asiata.addCommand({pattern: 'pmttssend ?(.*)', fromMe: true, desc: psmm, deleteCommand: false}, (async (message, match) => {
    if (!message.reply_message) return await message.client.sendMessage(message.jid,NLang.NEED_REPLY, MessageType.text);
    if (message.reply_message && match[1] == '') return await message.client.sendMessage(message.jid, NLang.NEED_WORDS, MessageType.text);
    let 
