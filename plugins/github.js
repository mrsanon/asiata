...
if (Config.WORKTYPE == 'private') {
    ...
    Asiata.addCommand({ pattern: 'github ?(.*)', fromMe: true, usage: USAGE, desc: PHONEDE_DESC, deleteCommand: false  }, async (message, match) => {
...
if (Config.WORKTYPE == 'public') {
   ...
   Asiata.addCommand({ pattern: 'github ?(.*)', fromMe: false, usage: USAGE, desc: PHONEDE_DESC, deleteCommand: false  }, async (message, match) => {
