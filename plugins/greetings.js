...
Asiata.addCommand({pattern: 'welcome$', fromMe: true, desc: Lang.WELCOME_DESC, deleteCommand: false}, (async (message, match) => {
...
Asiata.addCommand({pattern: 'welcome (.*)', fromMe: true, dontAddCommandList: true, deleteCommand: false}, (async (message, match) => {
    if (match[1] === '') {
...
Asiata.addCommand({pattern: 'goodbye$', fromMe: true, desc: Lang.GOODBYE_DESC, deleteCommand: false}, (async (message, match) => {
...
Asiata.addCommand({pattern: 'goodbye (.*)', fromMe: true, dontAddCommandList: true, deleteCommand: false}, (async (message, match) => {
    if (match[1] === '') {
