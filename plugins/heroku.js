...
Asiata.addCommand({pattern: 'degis ?(.*)', fromMe: true, desc: Lang.DEGİS_DESC, deleteCommand: false }, (async (message, match) => {
...
Asiata.addCommand({pattern: 'restart$', fromMe: true, desc: Lang.RESTART_DESC , deleteCommand: false}, (async (message, match) => {
...
Asiata.addCommand({pattern: 'shutdown$', fromMe: true, desc: Lang.SHUTDOWN_DESC, deleteCommand: false }, (async(message, match) => {
...
if (Config.WORKTYPE == 'private') {
    ...
    Asiata.addCommand({pattern: 'dyno$', fromMe: true, desc: Lang.DYNO_DESC, deleteCommand: false}, (async (message, match) => {
    ...
    Asiata.addCommand({pattern: 'dyno$', fromMe: false, desc: Lang.DYNO_DESC, deleteCommand: false }, (async (message, match) => {
...
Asiata.addCommand({pattern: 'dyno$', fromMe: true, dontAddCommandList: true, deleteCommand: false }, (async (message, match) => {
...
Asiata.addCommand({pattern: 'setvar ?(.*)', fromMe: true, desc: Lang.SETVAR_DESC , deleteCommand: false }, (async(message, match) => {
...
Asiata.addCommand({pattern: 'delvar ?(.*)', fromMe: true, desc: Lang.DELVAR_DESC, deleteCommand: false }, (async (message, match) => {
...
Asiata.addCommand({pattern: 'getvar ?(.*)', fromMe: true, desc: Lang.GETVAR_DESC, deleteCommand: false}, (async (message, match) => {
