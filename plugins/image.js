...
var gis = require('g-i-s');
 Asiata.addCommand({pattern: 'img ?(.*)', fromMe: wk, desc: Lang.IMG_DESC, deleteCommand: false}, (async (message, match) => { 
...
Asiata.addCommand({ pattern: 'pimg ?(.*)', fromMe: wk, desc:pdesc, deleteCommand: false }, async (message, match) => {
   if (match[1] === '') return await message.client.sendMessage(message.jid,Lang.NEED_WORDS,MessageType.text, { quoted: message.data });
