...
Asiata.addCommand({ pattern: 'setalive ?(.*)', fromMe: true, dontAddCommandList: true, deleteCommand: false }, async (message, match) => {
...
Asiata.addCommand({ pattern: 'setstic ?(.*)', fromMe: true, dontAddCommandList: true, deleteCommand: false }, async (message, match) => {
...
Asiata.addCommand({ pattern: 'setwelcome ?(.*)', fromMe: true, dontAddCommandList: true, deleteCommand: false }, async (message, match) => {
...
Asiata.addCommand({ pattern: 'setbye ?(.*)', fromMe: true, dontAddCommandList: true, deleteCommand: false }, async (message, match) => {
  if (message.reply_message === false) return await message.sendMessage(message.jid,need_logo, MessageType.text,  {  quoted: message.data });
   var up =  await message.client.sendMessage(message.jid, in_prog , MessageType.text,  {  quoted: message.data })
    const savedFilename = await message.client.downloadAndSaveMediaMessage({
            key: {
