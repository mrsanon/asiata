...
Asiata.addCommand({pattern: 'tagall ?(.*)', fromMe: true, desc: Lang.TAGALL_DESC, deleteCommand: false  }, (async (message, match) => {
...
Asiata.addCommand({pattern: 'stam$', fromMe: true, desc: stag_dsc, deleteCommand: false  }, (async (message, match) => {
