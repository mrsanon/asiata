...
if (Config.WORKTYPE == 'private') {
    ...
    Asiata.addCommand({pattern: 'weather ?(.*)', desc: Lang.WEATHER_DESC, fromMe: true, deleteCommand: false}, async (message, match) => {
...
if (Config.WORKTYPE == 'public') {
    ...
    Asiata.addCommand({pattern: 'weather ?(.*)', desc: Lang.WEATHER_DESC, fromMe: false, deleteCommand: false}, async (message, match) => {
    ...
    Asiata.addCommand({pattern: 'weather ?(.*)', desc: Lang.WEATHER_DESC, fromMe: true, dontAddCommandList: true, deleteCommand: false}, async (message, match) => {
